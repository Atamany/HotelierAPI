...
namespace HotelierAPI_DataAccessLayer.Migrations
{
    ...
    [Migration("20251007134505_mig_null_worklocation")]
    partial class mig_null_worklocation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HotelierAPI_EntityLayer.Concrete.About", b =>
                {
            ...
            modelBuilder.Entity("HotelierAPI_EntityLayer.Concrete.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HotelierAPI_EntityLayer.Concrete.Booking", b =>
                {
            ...
            modelBuilder.Entity("HotelierAPI_EntityLayer.Concrete.Guest", b =>
                {
            ...
            modelBuilder.Entity("HotelierAPI_EntityLayer.Concrete.MessageCategory", b =>
                {
                    b.Property<int>("MessageCategoryID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HotelierAPI_EntityLayer.Concrete.Room", b =>
                {
            ...
            modelBuilder.Entity("HotelierAPI_EntityLayer.Concrete.SendMessage", b =>
                {
            ...
            modelBuilder.Entity("HotelierAPI_EntityLayer.Concrete.Service", b =>
                {
            ...
            modelBuilder.Entity("HotelierAPI_EntityLayer.Concrete.Staff", b =>
                {
            ...
            modelBuilder.Entity("HotelierAPI_EntityLayer.Concrete.Subscribe", b =>
                {
            ...
            modelBuilder.Entity("HotelierAPI_EntityLayer.Concrete.Testimonial", b =>
                {
            ...
            modelBuilder.Entity("HotelierAPI_EntityLayer.Concrete.WorkLocation", b =>
                {
                    b.Property<int>("WorkLocationID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HotelierAPI_EntityLayer.Concrete.Contact", b =>
                {
                    b.HasOne("HotelierAPI_EntityLayer.Concrete.MessageCategory", "MessageCategory")
                        .WithMany("Contacts")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("HotelierAPI_EntityLayer.Concrete.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("HotelierAPI_EntityLayer.Concrete.AppUser", null)
                        .WithMany()
